...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../lab61.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80091f0
SOPC_SYSID_FLAG += --sidp=0x80091f0
ELF_PATCH_FLAG  += --sidp 0x80091f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1670546481
SOPC_SYSID_FLAG += --timestamp=1670546481
ELF_PATCH_FLAG  += --timestamp 1670546481
